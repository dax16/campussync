...
export default function Register() {
  const [form, setForm] = useState({ name: '', email: '', password: '', studentId: '', program: 'ITS', semester: 2 });
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              ...
              <input
                ...
                required
              />
              <p className="field-hint">Use your Student ID as your email name, for example s0123456@campus.ca.</p>
            </div>
            <div className="form-group">
              <label>Program</label>
              <select value={form.program} onChange={e => setForm({...form, program: e.target.value})}>
                <option value="ITS">Information Technology Solutions</option>
                <option value="ESD">Enterprise Software Development</option>
